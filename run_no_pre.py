...
def main():
    ...
    #parser.add_argument("--file", type=int, default=128) return_remaining_strings=True
...
#        print(len(second_sentences))
    ...
    if training_args.do_predict:
        ...
        file = open(data_args.test_file, "w")
        for i, data in enumerate(raw_datasets["test"]):
            data["context"] = data[f"ending{results.predictions[i].argmax()}"]
